const Experience: React.FC = () => {
    return (
        <section className="border-2 w-full rounded-[0.75em] border-black dark:border-white px-10 py-6 shadow-dark-shadow dark:shadow-light-shadow bg-light-teal dark:bg-dark-teal">
